  ...
  return (
    <section id="hero" className="relative flex min-h-screen items-center justify-center px-6">
      ...
      <motion.div
        ...
        className="pointer-events-none absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[500px] w-[500px] rounded-full bg-accent/5 blur-[120px]"
      />
      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        ...
        >
          ...
          contribute to challenging and growth-oriented teams.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
